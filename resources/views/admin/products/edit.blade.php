                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control select2 {{ $errors->has('product_category') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($product_categories as $id => $entry)
                                <option value="{{ $id }}"
                                    {{ (old('product_category_id') ? old('product_category_id') : $product->product_category->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('current_stock') ? 'is-invalid' : '' }}" type="number"
                            ...
                            value="{{ old('current_stock', $product->current_stock) }}" step="1" required>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control select2 {{ $errors->has('product_tags') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($product_tags as $id => $product_tag)
                                <option value="{{ $id }}"
                                    {{ in_array($id, old('product_tags', [])) || $product->product_tags->contains($id) ? 'selected' : '' }}>
                                    {{ $product_tag }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control select2 {{ $errors->has('product_offers') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($product_offers as $id => $product_offer)
                                <option value="{{ $id }}"
                                    {{ in_array($id, old('product_offers', [])) || $product->product_offers->contains($id) ? 'selected' : '' }}>
                                    {{ $product_offer }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('information') ? 'is-invalid' : '' }}" name="information"
                            id="information">{!! old('information', $product->information) !!}</textarea>
