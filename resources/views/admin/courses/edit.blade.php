                ...
                <div class="row justify-content-center">
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                            name="name" id="name" value="{{ old('name', $course->name) }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('trainer') ? 'is-invalid' : '' }}" type="text"
                            name="trainer" id="trainer" value="{{ old('trainer', $course->trainer) }}" required>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control date {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text"
                            name="start_at" id="start_at" value="{{ old('start_at', $course->start_at) }}" required>
                ...
                <div class="row justify-content-center">
                    <div class="form-group col-6">
                        ...
                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                            id="description" required>{{ old('description', $course->description) }}</textarea>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('courses_hours') ? 'is-invalid' : '' }}" type="number"
                            name="courses_hours" id="courses_hours"
                            value="{{ old('courses_hours', $course->courses_hours) }}" step="0.01">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type"
                            ...
                            @foreach (App\Models\Course::TYPE_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('type', $course->type) === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('type'))
