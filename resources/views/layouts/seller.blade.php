...
<body class="bg-gray-100">
    <!-- start navbar -->
    <div
        class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300 rtl">
        <!-- logo -->
        <div class="flex-none w-56 flex flex-row items-center">
            <a href="{{ route('frontend.home') }}">
                <img src="{{ asset('assets/images/logo.png') }}" class="w-10 flex-none" alt="Site Logo" />
            </a>
        ...
        <button id="navbarToggle" class="hidden md:block md:fixed left-0 ml-6">
        ...
        <div id="navbar"
            ...
            <div class="flex flex-row-reverse items-center">
                ...
                <div class="dropdown relative md:static">
                    <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                        <div class="w-8 h-8 overflow-hidden rounded-full">
                            @php
                                ...
                                $seller && $seller->photo
                                    ? ($img = $seller->photo->getUrl('thumb'))
                                    : ($img = asset('assets/images/blank.jpg'));
                    ...
                    <div
                        class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 left-0 w-40 mt-5 py-2 animated faster">
                        <!-- item -->
                ...
                <!-- end user -->
                <!-- notifcation -->
                <div class="dropdown relative ml-5 md:static">
                    <button
                        ...
                        <span id="header-action-num" class="header-action-num"> {{auth()->user()->userUserAlerts()->count()}}
                        </span>
                    </button>
                    <button class="hidden fixed top-0 left-0 z-10 w-full h-full menu-overflow"></button>
                    <div
                        class="menu hidden rounded bg-white md:right-0 md:w-full shadow-md absolute z-20 left-0 w-84 mt-5 py-2 animated faster">
                        <!-- top -->
                        <div
                            ...
                            <div class="bg-teal-100 border border-teal-200 text-teal-500 text-xs rounded px-1">
                                <strong> {{auth()->user()->userUserAlerts()->count()}}</strong>
                            </div>
                        </div>
                        <hr>
                        <!-- end top -->
                        <!-- body -->
                        <!-- item -->
                      @foreach(auth()->user()->userUserAlerts as $notif)  
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            href="#">
                            <div class="px-3 py-2 rounded ml-3 bg-gray-100 border border-gray-300">
                ...
                <div class="dropdown relative mr-5 md:static">
                    ...
                    <div
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            href="#">
                            <div
                                class="w-10 h-10 rounded-full overflow-hidden ml-3 bg-gray-100 border border-gray-300">
        ...
        <div id="sideBar"
            ...
            <div class="flex flex-col">
                ...
                <a href="{{ route('seller.home') }}"
                    ...
                    <i class="fad fa-shopping-cart text-xs ml-2"></i>الرئيسية </a>
                <!-- end link -->
                ...
                <a href="{{ route('seller.profile') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500 rtl">
                    <i class="fad fa-shopping-cart text-xs ml-2"></i> حسابي</a>
                <!-- end link -->
